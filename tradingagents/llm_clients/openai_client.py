...
_DEFAULT_CHAT_CLASS = NormalizedChatOpenAI
...
class ProviderSpec:
    ...
    chat_class: type = _DEFAULT_CHAT_CLASS # provider quirks live in the subclass
    ...
    def get_llm(self) -> Any:
        ...
        if spec is not None:
            chat_cls = (
                ...
                if spec.chat_class is _DEFAULT_CHAT_CLASS
                else spec.chat_class
            )
