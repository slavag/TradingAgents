...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    "final_report_llm": "gpt-5.4-mini",
    # When None, each provider's client falls back to its own default endpoint
    # (api.openai.com for OpenAI, generativelanguage.googleapis.com for Gemini, ...).
    # The CLI/web override this per provider when the user picks one. Keeping a
    # provider-specific URL here would leak it into other providers.
    "backend_url": None,
    "deep_think_provider": None,
    "quick_think_provider": None,
    "final_report_provider": None,
    "deep_backend_url": None,
    "quick_backend_url": None,
    "final_report_backend_url": None,
